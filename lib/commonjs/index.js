...
_config.default.addProcessorToMap(OP_CAST_ARRAY, 'OP_CAST_ARRAY', true, left => left == null ? null : Array.isArray(left) ? left : [left]);
...
_config.default.addProcessorToMap(OP_JOIN, 'OP_JOIN', false, (left, right) => {
  if (left == null) return null;
