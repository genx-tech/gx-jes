...
const OP_JOIN = [_transformerOperators.default.JOIN, BINARY, '$join'];
...
const OP_ASSIGN = [_transformerOperators.default.ASSIGN, BINARY, '$assign', '$override'];
...
_config.default.addTransformerToMap(OP_ASSIGN, (left, right, context) => {
  ...
  const rightValue = (0, _mapValues2.default)(right, (expr, key) => (0, _transform.default)(left[key], expr, (0, _config.getChildContext)(context, left, key, left[key])));
  return { ...left,
    ...rightValue
  };
});
