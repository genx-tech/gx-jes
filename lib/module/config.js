...
const formatName = (name, left, context, custom) => {
  const fullName = name == null ? context.path : makePath(name, context === null || context === void 0 ? void 0 : context.path);
...
export const getChildContext = (context, currentValue, childKey, childValue) => ({ ...context,
