...
const IF = 'If Else'; //Type casting operators (pure)

const CAST_ARRAY = 'Cast To Array'; //Math operators (pure)

const ADD = 'Add';
const SUB = 'Subtract';
const MUL = 'Multiply';
const DIV = 'Divide';
const MOD = 'Remainder'; //Collection operators (pure)
...
const TO_OBJ = 'JSON Parse'; //Value updater (pure, copy on write)

const SET = 'Set Value';
const ADD_ITEM = 'Add K-V Entry';
const ASSIGN = 'Assign';
const APPLY = 'Apply Transformation';
const INTERPOLATE = 'Interpolate'; //Colllection modifier
