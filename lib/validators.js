...
const processRightValue = (right, context) => typeof right === 'string' || (0, _july.isPlainObject)(right) ? (0, _transform.default)(undefined, right, context, true) : right;
...
const OP_EXISTS = [_validateOperators.default.EXISTS, '$exist', '$exists', '$notNull'];
const OP_REQUIRED = [_validateOperators.default.REQUIRED, '$required', '$mandatory'];
const OP_MATCH = [_validateOperators.default.MATCH, '$has', '$match', '$all', '$should'];
...
_config.default.addValidatorToMap(OP_EQUAL, (left, right, options, context) => (0, _isEqual2.default)(left, processRightValue(right, context)));
_config.default.addValidatorToMap(OP_NOT_EQUAL, (left, right, options, context) => !(0, _isEqual2.default)(left, processRightValue(right, context)));
